...
def main():
    ...
    TEST_sgd_W_m_1 = np.allclose(W_1.round(4), W_1_solution)
    print("Test W (Step 1):", TEST_sgd_W_m_1)

    TEST_sgd_b_m_1 = np.allclose(b_1.round(4), b_1_solution)
    print("Test b (Step 1):", TEST_sgd_b_m_1)

    TEST_sgd_W_m_2 = np.allclose(W_2.round(4), W_2_solution)
    print("Test W (Step 2):", TEST_sgd_W_m_2)

    TEST_sgd_b_m_2 = np.allclose(b_2.round(4), b_2_solution)
